...
lv_obj_t * ui_loading_screen_button_button3;
lv_obj_t * ui_loading_screen_label_label1;
...
void ui_event_loading_screen_button_button3(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_RELEASED) {
        _ui_screen_change(&ui_weight_screen, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_weight_screen_screen_init);
    }
}
void ui_event_weight_screen_button_button1(lv_event_t * e)
{
